    ...
    <div className="editModal__content_container">
      ...
      <div className="editModal__contentForm_container">
        ...
        <form className="editModal__contentForm_form">
          <InputTextAdmin name="Name" id="titleInput" type="text" onChange={props.titleGetter} value={props.titleInp} />
          <OptionSelect
            name="Category"
            id="genre"
          ...
          <Checkbox name="PC" checked={props.pcCheckedInp} onChange={props.pcCheckHandler} onKeyUp={props.onKeyUpPc} />
          <Checkbox name="PS" checked={props.psCheckedInp} onChange={props.psCheckHandler} onKeyUp={props.onKeyUpPs} />
          <Checkbox
            name="XBox"
